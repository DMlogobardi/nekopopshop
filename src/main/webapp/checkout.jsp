            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4" id="shipping-address-list">
                        <!-- Address 1 -->
                        <div class="address-option p-4 border rounded-lg cursor-pointer hover:border-nekopeach selected-address">
                            <div class="flex justify-between">
                                <div>
                                    <h3 class="font-bold">Casa</h3>
                                    <p class="text-sm text-gray-600">Mario Rossi</p>
                                    <p class="text-sm text-gray-600">Via Roma 123, 20100 Milano</p>
                                    <p class="text-sm text-gray-600">Italia</p>
                                    <p class="text-sm text-gray-600">Tel: 1234567890</p>
                                </div>
                                <i class="fas fa-check text-nekopeach mt-1"></i>
                            </div>
                        </div>
