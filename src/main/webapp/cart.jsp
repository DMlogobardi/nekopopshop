  ...
  <div class="flex flex-col lg:flex-row items-center justify-between gap-6 mb-8">
    ...
    <div class="w-full lg:w-auto">
      <div class="flex flex-wrap justify-center lg:justify-start -mb-1">
        ...
        <a href="cart.html" class="folder-tab active"><i class="fas fa-shopping-cart mr-2"></i> Carrello</a>
        <a href="admin.html" class="folder-tab"><i class="fas fa-user-shield mr-2"></i> Admin</a>
        <a href="profile.html" class="folder-tab"><i class="fas fa-user mr-2"></i> Utente</a>
      </div>
    </div>
  </div>
