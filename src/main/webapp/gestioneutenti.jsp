            ...
            <form>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="userAvatar">Avatar</label>
            ...
            <div>
                ...
                <div class="flex mt-2">
                    ...
                    <button class="bg-white text-nekopink font-bold px-4 rounded-r-lg">
                        <i class="fas fa-p paper-plane"></i>
                    </button>
                </div>
